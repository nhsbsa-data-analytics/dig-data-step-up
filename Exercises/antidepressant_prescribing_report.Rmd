...
In regards to cell block run options, if you add *warning=FALSE* this will prevent messages relating to the running of code being included in your html report output.
...
If you have dome dplyr code that generates a tablee (or pivot table) just pipe (%>%) the *kable* at the end of your code. For example
