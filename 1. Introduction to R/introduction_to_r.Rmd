...
knitr::opts_knit$set(root.dir = "C:/Users/ADNSH/OneDrive - NHS Business Services Authority/GitHub/dig-data-step-up")
```
...
This dataset now contains 5 columns:
...
- howw to check the number of levels in a factor type column
