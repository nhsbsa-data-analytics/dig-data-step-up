...
It's called *tidyr* and used for data transformation and maniupation.
Here is a cheatsheet if you want to see what other functions it has. 
...
As we can see, we now have a table that is more reable and could be included within a report.
